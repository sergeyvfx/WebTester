 ...
 *
 * Part of the lrvm - client part of the killer of LibRUN
 *
...
/**
 * Get user ID by user's name
 *
 * @param __self - user name
 * @return UID
 */
static long
...
/**
 * Get group ID by group's name
 *
 * @param __self - group name
 * @return GID
 */
static long
get_gid (const char *__self)
{
